...
void initUART(void)
{
	...
	U0DLL=0x14;//0x0014 for 9600bps(Divisor=PCLK/baudrate*16)
	U0DLM=0x00;
...
void sendUART(int mydata)
{
	U0THR=mydata;
	while(!(U0LSR&(1<<6)));//check if transmission is over,see the status of TEMT flag
