...
and rectangular wave on port pin P0.5 using external interrupt 1.Configure both interrupt sources as FIQ.
...
{
	PINSEL0=(3<<2)|(3<<6);
	VICIntSelect|=(1<<14)|(1<<15);//external interrupt 0 and 1 confogurred as FIQ
